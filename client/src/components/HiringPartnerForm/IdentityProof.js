    ...
    return(
        <div className='hr-form-container'>
            ...
            <form onSubmit={onSubmitIdentityProof} className='hr-form'>
                ...
                <label htmlFor='pan' className='hr-label'>PAN Number</label>
                ...
                <label htmlFor='emergency-number' className='hr-label'>Emergency Contact</label>
                ...
                <label htmlFor='name1' className='hr-label'>Name</label>
                ...
                <label htmlFor='relationship1' className='hr-label'>Relationship</label>
                ...
                <label htmlFor='organization1' className='hr-label'>Occupation/Organization</label>
                ...
                <label htmlFor='age1' className='hr-label'>Age</label>
                ...
                <label htmlFor='know' className='hr-label'>Dependent on you?</label>
                ...
                <label htmlFor='name2' className='hr-label'>Name</label>
                ...
                <label htmlFor='relationship2' className='hr-label'>Relationship</label>
                ...
                <label htmlFor='organization2' className='hr-label'>Occupation/Organization</label>
                ...
                <label htmlFor='age2' className='hr-label'>Age</label>
                ...
                <label htmlFor='name3' className='hr-label'>Name</label>
                ...
                <label htmlFor='relationship3' className='hr-label'>Relationship</label>
                ...
                <label htmlFor='organization3' className='hr-label'>Occupation/Organization</label>
                ...
                <label htmlFor='age3' className='hr-label'>Age</label>
